"""Integration Test TradeETLMethods"""
import os
import unittest
...
class IntTestTradeETLMethods(unittest.TestCase):
    """
    Integration testing the TradeETL class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'trade-etl-int-test-src'
        self.s3_bucket_name_trg = 'trade-etl-int-test-target'
