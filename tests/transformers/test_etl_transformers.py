...
from tradeETL.transformers.etl_transformer import etlSourceConfig, etlTargetConfig, TradeETL

class TestETLMethods(unittest.TestCase):
    """
    Testing the TradeETL class.
    """
    ...
    def setUp(self):
        ...
        conf_dict_trg = {
            ...
            'trg_key': 'report1/Trade_daily_report1_',
    ...
    def test_extract_no_files(self):
        ...
        return_value=[extract_date, extract_date_list]):
            Trade_etl = TradeETL(self.s3_bucket_src, self.s3_bucket_trg,
                         self.meta_key, self.source_config, self.target_config)
            df_return = Trade_etl.extract()
    ...
    def test_transform_report1_emptydf(self):
        ...
        return_value=[extract_date, extract_date_list]):
            ...
            with self.assertLogs() as logm:
                df_result = trade_etl.transform_report1(df_input)
    ...
    def test_transform_report1_ok(self):
        ...
        """
        # Expected results
        log1_exp = 'Applying transformations to Trade source data for report 1 started...'
        log2_exp = 'Applying transformations to Trade source data finished...'
    ...
    def test_load(self):
        ...
        """
        # Expected results
        log1_exp = 'Trade target data successfully written.'
        log2_exp = 'Trade meta file successfully updated.'
        df_exp = self.df_report
